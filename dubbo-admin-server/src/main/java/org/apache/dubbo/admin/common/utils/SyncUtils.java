...
public class SyncUtils {
   ...
   * @param filter
   * @param <M>
   * @return Map<category, Map<serviceName, Map<Long, URL>>>
   */
  public static <M extends Map<String, Map<String, URL>>> Map<String, URL> filterFromCategory(
      Map<String, M> urls, Map<String, String> filter) {
   ...
   * @param urls
   * @param filter
   * @return Map<serviceName, Map<Long, URL>>
   */
  public static Map<String, URL> filterFromService(
      Map<String, Map<String, URL>> urls, Map<String, String> filter) {
    Map<String, URL> ret = new ConcurrentHashMap<>(8);
    if (urls == null) {
      return ret;
    }
  ...
  public static <M extends Map<String, Map<String, URL>>> Pair<String, URL> filterFromCategory(
      Map<String, M> urls, String category, String id) {
    M services = urls.get(category);
    if (services == null) {
      return null;
    }
