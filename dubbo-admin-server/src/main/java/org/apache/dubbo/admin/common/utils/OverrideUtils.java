...
public class OverrideUtils {
  ...
  public static OverrideConfig balancingDto2Config(BalancingDTO balancingDTO) {
    OverrideConfig overrideConfig = new OverrideConfig();
  ...
  public static DynamicConfigDTO createFromOverride(OverrideDTO overrideDTO) {
    ...
    dynamicConfigDTO.setEnabled(overrideDTO.getEnabled());
    return dynamicConfigDTO;
  }

  public static WeightDTO config2WeightDTO(OverrideConfig config, String scope, String key) {
  ...
  public static BalancingDTO config2BalancingDTO(OverrideConfig config, String scope, String key) {
